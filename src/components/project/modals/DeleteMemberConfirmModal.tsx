              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    Are you sure you want to remove <strong>{getMemberName()}</strong> from this project? 
                    This {getMemberType()} will no longer have access to the project based on this membership.
                  </p>
                </div>
              </div>
            </div>
