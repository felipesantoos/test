        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    Are you sure you want to delete {selectedIssues.length} issues? This action cannot be undone.
                  </p>
                  <div className="mt-4 max-h-40 overflow-y-auto">
                    <ul className="divide-y divide-gray-200">
                      {selectedIssues.map(issue => (
                        <li key={issue.id} className="py-2">
                          <div className="text-sm text-gray-900">#{issue.id}: {issue.subject}</div>
          ...
          <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            ...
            >
              ...
              {isLoading ? 'Deleting...' : 'Delete Issues'}
            </button>
            <button
              type="button"
              onClick={onClose}
